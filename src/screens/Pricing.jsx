  ...
  return (
    <>
      ...
      <div className="grid gap-4 place-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <Plans
          planName={"meeting one time plan"}
          price={"$5"}
          info={"Basic features for up to 10 users."}
          time={"one time"}
        />
        <Plans
          planName={"meeting enterprise plan"}
          price={"$20"}
          info={"Growing teams up to 20 users."}
          time={"per month"}
        />
        <Plans
          planName={"meeting enterprise plan"}
        ...
        />
        <Plans
          planName={"meeting Premium plan"}
          price={"$40"}
          info={"Advanced features + unlimited users."}
          time={"per year"}
        />
      </div>
      {/* Next Section */}

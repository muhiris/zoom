      ...
      <div className=" pr-4 overflow-x-hidden flex-between flex-col lg:flex-row">
        <div className=" flex items-center justify-center flex-col ml-4 lg:ml-20 lg:items-start lg:justify-start">
          ...
          <div className="flex-between">
            ...
            <button className="bg-white text-black border-2 border-[#3f3f3f] ml-6 px-6 py-4  rounded-2xl hover:shadow-secondary shadow-sm transition-all duration-300 ease-in-out">
              {btn2}
            </button>
          </div>
        </div>
